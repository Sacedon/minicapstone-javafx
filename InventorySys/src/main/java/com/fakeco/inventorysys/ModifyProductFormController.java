...
public class ModifyProductFormController
{
     ...
     * a Product object and sets the local variable.
     * @param p The Product passed from another class.*/
    public static void receiveData(Product p){
        passedProduct = p;
    }
    ...
    public void cancelHandler(ActionEvent actionEvent) throws IOException {
        System.out.println(passedProduct.getAllAssociatedParts());
        newList = null;
